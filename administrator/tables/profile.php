...
class SponsorsTableprofile extends JTable
{
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_sponsors.profile.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_sponsors/access.xml',
				"/access/section[@name='profile']/"
			);
			$default_actions = JAccess::getAssetRules('com_sponsors.profile.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_sponsors');
