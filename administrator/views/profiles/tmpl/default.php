...
$document->addStyleSheet(JUri::root() . 'administrator/components/com_sponsors/assets/css/sponsors.css');
$document->addStyleSheet(JUri::root() . 'media/com_sponsors/css/list.css');

$user = JFactory::getUser();
$userId = $user->get('id');
$listOrder = $this->state->get('list.ordering');
$listDirn = $this->state->get('list.direction');
$canOrder = $user->authorise('core.edit.state', 'com_sponsors');
$saveOrder = $listOrder == 'a.`ordering`';

if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_sponsors&task=profiles.saveOrderAjax&tmpl=component';
        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped" id="profileList">
                ...
                <?php foreach ($this->items as $i => $item) :
                    ...
                    $canCreate = $user->authorise('core.create', 'com_sponsors');
                    $canEdit = $user->authorise('core.edit', 'com_sponsors');
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td>
                            ...
                            <?php endif; ?>
                            <?php if ($canEdit) : ?>
                                <a href="<?php echo JRoute::_('index.php?option=com_sponsors&task=profile.edit&id=' . (int)$item->id); ?>">
