 ...
 * @since  1.6
 */
class SponsorsViewProfile extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_SPONSORS_TITLE_PROFILE'), 'profile.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_sponsors.profile', $this->item->id);
		}
